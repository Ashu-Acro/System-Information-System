...
if(!empty($_POST))
{
	...
	$_SESSION['adhaar_no'] = $_POST['adhaar_no'];
...
<span class="heading">ACROPOLIS INSTITUTE OF TEHCNOLOGY AND RESEARCH</span>
</div>
<br>
<br>
...
<br>
<br>
<input type="text" name="adhaar_no" title="Enter 12 Digit Adhaar No." placeholder="12 Digit Adhaar No." required maxlength="12" size="30" value="<?php echo $_SESSION['adhaar_no'];?>" />
<br>
<br>
